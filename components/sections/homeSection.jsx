...
const HomeSection = props => {
  ...
  return (
      <div id="home" className=" xl:w-11/12 xl:translate-x-20 bg-cover bg-center shadow-xl rounded-3xl xl:mt-30 mt-20 h-full" style={{ backgroundImage: `url(${backgroundUrl}`}}>
